  ...
  return (
    <section id='product-viewer'>
        ...
        <div className='controls'>
            <p className='info'>MacbookPro {scale === 0.06 ? "14\"" : "16\""} in {color === "#abd5bd" ? "Space Silver" : "Space Black"}</p>
            <div className='flex-center gap-5 mt-5'>
                <div className='color-control'>
                    <div onClick={()=>setColor("#abd5bd")} className={clsx("bg-neutral-300", color === "#abd5bd" && "active")}></div>
                    <div onClick={()=>setColor("#2e2c3e")} className={clsx("bg-neutral-900", color === "#2e2c3e" && "active")}></div>
